        ...
        data() {
            return {
                ...
                rcp_2: `<p class="cp9g">Localización de los sitios arqueológicos pertenecientes a las comunidades de recolectores-cazadores-pescadores </p>
                    <p>Como se puede apreciar en el plano, la mayor concentración de estos sitios se encuentra situada en el oeste del municipio de Río Cauto, el norte y oeste de Yara y el norte de Manzanillo, vinculados a deltas y cauces de ríos, zonas cenagosas y arroyos. Se presentan con menos frecuencia, en los municipios de Campechuela, Media Luna, Niquero y Pilón. Aun menor medida aparecen en áreas lejanas de las zonas cenagosas y del mar, específicamente en los municipios de Cauto Cristo, Jiguaní, Guisa, Bayamo, Manzanillo, Buey Arriba, Bartolomé Masó, Campechuela, Media Luna y Niquero.</p>
                    <p>Estos recolectores-cazadores-pescadores, ubicados cerca del mar, hacían un gran uso de los moluscos marinos para su alimentación y emplean sus conchas (caracoles) para la confección de herramientas y vasijas. Todos empleanla piedra tallada, a partir, en lo fundamental, del sílex, la piedra en volumen de diferentes rocas y los cantos rodados. Es lógico que utilizaran la madera y las fibras vegetales, pero por las características de nuestro clima, se descomponen con facilidad y su aparición en los sitios arqueológicos es escasa. Estas comunidades vivían en las cavernas y también en áreas despejadas, por lo que deben haber construido alguna vivienda rústica. </p>
                ...
                rcp_gallery: [
                    ...
                    {title:'Martillo elaborado a partir de la concha del cobo. Guamito, municipio de Río Cauto',url:'static/images/pages/comunidades/foto_3.jpg'},
                ...
                ac_2: `<p class="cp9g">Localización de los sitios arqueológicos pertenecientes a los agricultores-ceramistas</p>
                    <p>Estas comunidades de agricultores-ceramistas usaron los recursos que la naturaleza les ofrecía para su alimentación y la confección de sus herramientas. Al igual que los recolectores-cazadores-pescadores, tallaban elsílex, trabajan la piedra en volumen, la madera y las fibras vegetales. Dominaban también la agricultura y la cerámica, lo que les permitía una vida más sedentaria; vivían en construcciones hechas de madera, guano y diferentes fibras vegetales. <p>
